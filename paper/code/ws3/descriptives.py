...
Run (from repo root):
  uv run --with-requirements paper/code/ws3/requirements.txt \
      python paper/code/ws3/descriptives.py
"""
...
# WS1 provenance helpers. __file__ = paper/code/ws3/descriptives.py
...
def _write_table(
    ...
    *,
    ...
    lines.append(
        "Generated by `paper/code/ws3/descriptives.py`. Numbers here are the ones cited "
