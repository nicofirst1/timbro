...
Run (from repo root):
  uv run --with-requirements paper/code/ws3/requirements.txt \
      python paper/code/ws3/step3_clustering/clustering.py
"""
...
# WS1 provenance helpers. __file__ = paper/code/ws3/step3_clustering/clustering.py
...
def _write_summary(summary_path: Path, **kw) -> None:
    ...
    L.append(
        "Generated by `paper/code/ws3/step3_clustering/clustering.py`. Numbers here are the ones cited in "
