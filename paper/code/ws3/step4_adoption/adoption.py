...
Run (from repo root):
  uv run --with-requirements paper/code/ws3/requirements.txt \
      python paper/code/ws3/step4_adoption/adoption.py
"""
...
# WS1 provenance helpers. __file__ = paper/code/ws3/step4_adoption/adoption.py
...
def render_report(ctx: dict) -> str:
    ...
    A("Generated by `paper/code/ws3/step4_adoption/adoption.py` — do not hand-edit. Numbers are the run's;")
...
def main() -> None:
    ...
    write_manifest(
        ...
        extra={
            ...
            "report": "paper/code/ws3/step4_adoption/step4_adoption.md",
