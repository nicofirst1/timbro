...
**Confirms our README's figure:** the "13.5K tasks are training data, eval bench = 200 instances" note in the citation whitelist (README §2) is accurate per this reading — training and evaluation sets are clearly separated and differently sized, and should not be conflated when citing "ClawGym's corpus size" in the manuscript.
